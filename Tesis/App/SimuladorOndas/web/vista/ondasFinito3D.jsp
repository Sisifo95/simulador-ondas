            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalCenterTitle"> ONDA 3D</h5>
                        <button type="button" onclick="cancel()" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>                        
                    </div>
                    <div class="form-group mx-2 nodo">
            ...
            <div class="container-full">
                <div class="row contenido">
                    <div class="col-12 menu " >
                        <h5 class=" my-2 mx-4 text-white text-uppercase"> Histórico ondas 3D </h5>        
                    </div>
                        ...
                        <div class="row lienzo my-xs-4">
                            <div class="col-xl-3  panel text-justify text-white " >
                                ...
                                <div class="mx-2 form-group text-justify " id="opciones">
                                    <!-- <a class="item "  href="../controlador/controlador.jsp?opc=ondasInfinito3D"> <i class="fas fa-file"></i> &nbsp;D'Alambert caso infinito  </a> <br>-->
                                    <div class="col espacio"></div>

                                    <a class="item"  href="../controlador/controlador.jsp?opc=ondasFinito3D"> <i class="fas fa-file"></i> &nbsp;Fourier caso finito </a> 
                                </div>
                            ...
                            <div id="contenidoReporte" class="areaReporte col-12  col-sm-12 col-md-9 tabla " >
                                <br>
                                <h2 >Datos ondas Fourier</h2>
                                <br>
                                        ...
                                        <%
                                            try {
                                                ...
                                                if (objOndas != null) {
                                                    ...
                                                    response.sendRedirect("../controlador/controlador.jsp?opc=getOndasFinito3D");
                                                }
                                            } catch (Exception e) {
