                ...
                <div class="row contenido">
                    ...
                    <div class="col-12">
                        <div class="row lienzo my-xs-4">
                            ...
                            <div id="contenidoReporte" style="overflow: auto" class="areaReporte col-12  col-sm-12 col-md-9 tabla " >
                                <br>
                                        ...
                                        <%
                                            try {
                                                ...
                                                if (objOndas != null) {
                                                    ...
                                                    response.sendRedirect("../controlador/controlador.jsp?opc=getOndasFinito2D");
                                                }
                                            } catch (Exception e) {
